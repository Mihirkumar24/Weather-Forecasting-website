...
const getWeather = (city) => {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Mumbai&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
      ...
      min_temp2.innerHTML = response.main.temp_min;
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=New Delhi&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Kolkata&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Mysore&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Pune&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);
      ...
      max_temp7.innerHTML = response.main.temp_max;
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Bangalore&appid=68c8998b8fa0f2a3b5af243607a8a3b3&units=metric`
  )
    .then(response => response.json())
    .then((response) => {
      console.log(response);

      temp7.innerHTML = response.main.temp;
      feels_like7.innerHTML = response.main.feels_like;
      humidity7.innerHTML = response.main.humidity;
      min_temp7.innerHTML = response.main.temp_min;
      max_temp8.innerHTML = response.main.temp_max;
